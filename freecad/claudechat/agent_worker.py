...
class AgentWorker(QtCore.QObject):
    ...
    tool_used = QtCore.Signal(str)          # name of a tool the agent invoked
    ...
    def _build_argv(self, text):
        ...
        argv = [
            ...
            "--model", cfg["model"],
            "--tools", "",               # disable Claude Code's built-ins (Bash/Write/etc.)
    ...
    def _handle_prompt(self, text):
        ...
        try:
            proc = subprocess.Popen(
                ...
                encoding="utf-8",
                errors="replace",
                cwd=tempfile.gettempdir(),  # neutral cwd: don't load any project CLAUDE.md
        ...
        if kind == "assistant":
            ...
            for block in obj.get("message", {}).get("content", []):
                ...
                if btype == "text" and block.get("text"):
                    ...
                    name = (block.get("name") or "").replace("mcp__freecad__", "")
