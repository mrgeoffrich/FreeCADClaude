...
SYSTEM_PROMPT = (
    ...
    "the image, and both accept x_min/x_max/y_min/y_max/z_min/z_max to zoom "
    "into a region (e.g. a specific hole or corner) instead of the whole part. "
    "When diagnosing a 3D issue, reach for orthographic SVG views "
